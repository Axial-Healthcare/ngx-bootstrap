...
var typeahead_directive_TypeaheadDirective = /** @class */ (function () {
    function TypeaheadDirective(ngControl, element, viewContainerRef, renderer, cis, changeDetection) {
        ...
        /** If enabled, options will not be filtered by field value on focus */
        this.typeaheadShowAllOnFocus = false;
        /** match latin symbols.
    ...
    typeahead_directive_decorate([
        Object(core_["Input"])()
    ], TypeaheadDirective.prototype, "typeaheadShowAllOnFocus", void 0);
    typeahead_directive_decorate([
        Object(core_["Input"])()
